...
def main(pdf_folder, output_path):
    ...
    img1 = extract_page_as_image(pdf_file, 8, crop=(0.05, 0.90), output_path=os.path.join(img_folder, "img1.png"))
    ...
    create_word_template_with_image(output_path, [img1, img2, img3, img4, img5])
